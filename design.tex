...
If all replicas in a replication group crash simultaneously, the data hosted by that group is permanently lost.
...
Instead of rolling back a partially completed migration transaction, the protocol always makes forward progress: once a group participates in a migration, it will eventually be transferred to its recipient group, along with all other groups in the transaction.
